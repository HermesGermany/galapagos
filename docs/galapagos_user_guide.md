...
<p align="center">
<img alt="Galapagos Login" src="./galapagos_user_guide_images/login.png" width="260">
</p>
...
<p align="center">
<img alt="Start screen" src="./galapagos_user_guide_images/start-screen.png" width="260">
</p>
...
On the dashboard (see screenshot above) you will find the following elements:
  ...
  * The Galapagos version.
  ...
  <p align="center">
  <img alt="Config Template" src="./galapagos_user_guide_images/config-template.png" width="260">
  </p>
...
## Search Topics
  ...
  <p align="center">
  <img alt="Browse Topics" src="./galapagos_user_guide_images/browse-topics.png" width="260">
  </p>
...
## Become a topic administrator
   ...
   <p align="center">
   <img alt="Topic Administrator" src="./galapagos_user_guide_images/AOR.png" width="260">
   </p>
...
## Generate client certificate      
   ...
   <p align="center">
   <img alt="Certificate" src="./galapagos_user_guide_images/client-cert.png" width="260">
   </p>
   
   A dialog for generating the certificate in the selected Kafka cluster opens:

   <p align="center">
   <img alt="Certificate Dialog" src="./galapagos_user_guide_images/cert-dialog.png" width="260">
   </p>
   ...
   * When the private key is generated by Galapagos, you will receive a .p12 file that is "protected" with the password "changeit". 
   ...
   <p align="center">
   <img alt="CSR" src="./galapagos_user_guide_images/csr-input.png" width="260">
   </p>
...
### Extend certificate      
   ...
   <p align="center">
   <img alt="Extend Certificate" src="./galapagos_user_guide_images/extend-cert.png" width="260">
   </p>
...
### Replace certificate
   ...
   <p align="center">
   <img alt="Certificate warning" src="./galapagos_user_guide_images/cert-warn.png" width="260">
   </p>
...
## Create developer certificate   
   ...
   <p align="center">
   <img alt="Developer Certificate" src="./galapagos_user_guide_images/dev-cert.png" width="260">
   </p>
...
## Create internal Topic   
   ...
   <p align="center">
   <img alt="Internal Topic" src="./galapagos_user_guide_images/topic-internal.png" width="260">
   </p>
...
## Subscribe to a Topic   
   ...
   <p align="center">
   <img alt="Subscription Section" src="./galapagos_user_guide_images/sub-section.png" width="260">
   </p>
   ...
   <p align="center">
   <img alt="Subscription Warn" src="./galapagos_user_guide_images/sub-warn.png" width="260">
   </p>
   ...
   <p align="center">
   <img alt="Unsubscribe" src="./galapagos_user_guide_images/unsub.png" width="260">
   </p>
...
## Create API Topic
   ...
   <p align="center">
   <img alt="API Topic" src="./galapagos_user_guide_images/api-topic.png" width="260">
   </p>
...
### Personal data in topics
   ...
   <p align="center">
   <img alt="Subscription approve" src="./galapagos_user_guide_images/sub-approve.png" width="260">
   </p>
...
### Delete JSON schema   
   ...
   <p align="center">
   <img alt="Delete Schema" src="./galapagos_user_guide_images/delete%20schema.png" width="260">
   </p>
...
## Staging   
   ...
   <p align="center">
   <img alt="Staging" src="./galapagos_user_guide_images/staging.png" width="260">
   </p>
...
### Delete internal Topic
   ...
   <p align="center">
   <img alt="Delete Topic" src="./galapagos_user_guide_images/delete-topic.png" width="260">
   </p>  
...
## Deprecation of API Topics
   ...
   <p align="center">
   <img alt="Deprecation" src="./galapagos_user_guide_images/deprecation1.png" width="260">
   </p>
   ...
   <p align="center">
   <img alt="Deprecation" src="./galapagos_user_guide_images/deprecation2.png" width="260">
   </p>   
   
   In addition, under the "Browse Topics" tab, deprecated topics are crossed out:

   <p align="center">
   <img alt="Deprecation" src="./galapagos_user_guide_images/deprecation3.png" width="260">
   </p>
...
## Undeprecation of API Topics
   ...
   <p align="center">
   <img alt="Deprecation" src="./galapagos_user_guide_images/deprecation4.png" width="260">
   </p>
...
## Change advanced topic settings
   ...
   <p align="center">
   <img alt="Topic Settings" src="./galapagos_user_guide_images/settingTopic.png" width="260">
   </p>
