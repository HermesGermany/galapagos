...
### Replace certificate
   ...
   <p align="center">
   <img alt="Certificate warning" src="./galapagos_user_guide_images/cert-warn.png" width="530" height="180">
   </p>
...
## Subscribe to a Topic   
   ...
   <p align="center">
   <img alt="Subscription Warn" src="./galapagos_user_guide_images/sub-warn.png" width="400" height="180">
   </p>
...
### Personal data in topics
   ...
   <p align="center">
   <img alt="Subscription approve" src="./galapagos_user_guide_images/sub-approve.png" width="530" height="180">
   </p>
