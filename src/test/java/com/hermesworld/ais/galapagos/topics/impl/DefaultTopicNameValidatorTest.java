...
public class DefaultTopicNameValidatorTest {
	...
	public void testTopicTypeNames() throws InvalidTopicNameException {
		...
		validator.validateTopicName("de.test.commands.goods.one.TwoThree", TopicType.COMMANDS, mockApp("TestApp", "Goods"),
				Mockito.mock(ApplicationMetadata.class));
	...
	public void testBusinessCapNames() throws InvalidTopicNameException {
		...
		validator.validateTopicName("de.test.events.goods.one.TwoThree", TopicType.EVENTS, mockApp("TestApp", "!&Goods"),
				Mockito.mock(ApplicationMetadata.class));
		validator.validateTopicName("de.test.events.goods.one.TwoThree", TopicType.EVENTS, mockApp("TestApp", "GoodsÖß"),
				Mockito.mock(ApplicationMetadata.class));
	}
	...
	public void testInvalidTopicTypeName1() throws InvalidTopicNameException {
		...
		validator.validateTopicName("de.test.events.goods.one.TwoThree", TopicType.COMMANDS, mockApp("TestApp", "Goods"),
				Mockito.mock(ApplicationMetadata.class));
	}
	...
	public void testInvalidTopicTypeName2() throws InvalidTopicNameException {
		...
		validator.validateTopicName("de.test.events.goods.one.TwoThree", TopicType.INTERNAL, mockApp("TestApp", "Goods"),
				mockMeta("testapp.internal."));
	}
	...
	public void testInvalidTopicTypeName3() throws InvalidTopicNameException {
		...
		validator.validateTopicName("de.test.internal.goods.one.TwoThree", TopicType.INTERNAL, mockApp("TestApp", "Goods"),
				mockMeta("testapp.internal."));
	}
	...
	public void testSuggestions() {
		...
		assertEquals("de.test.events.goods.my-topic",
				validator.getTopicNameSuggestion(TopicType.EVENTS, app, Mockito.mock(ApplicationMetadata.class),
						app.getBusinessCapabilities().get(0)));
		...
		assertEquals("de!test!commands!goods!my-topic",
				validator.getTopicNameSuggestion(TopicType.COMMANDS, app, Mockito.mock(ApplicationMetadata.class),
						app.getBusinessCapabilities().get(0)));
	}
