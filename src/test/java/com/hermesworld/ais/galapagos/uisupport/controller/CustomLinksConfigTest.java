...
public class CustomLinksConfigTest {
	...
	public void testCustomLinksConfigID() {
		CustomLinkConfig customLinkConfig = generatedCustomLinkConfig(null, "www.test.de", "Test-Label", LinkType.OTHER);
	...
	public void testCustomLinkConfigPositive() {
		CustomLinkConfig customLinkConfig = generatedCustomLinkConfig("42", "www.test.de", "Test-Label", LinkType.OTHER);
		new CustomLinksConfig().setLinks(Collections.singletonList(customLinkConfig));
	}
