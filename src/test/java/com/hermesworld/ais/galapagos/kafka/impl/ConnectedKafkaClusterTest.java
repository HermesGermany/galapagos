...
public class ConnectedKafkaClusterTest {
	...
	public void testUpdateAcls() throws Exception {
		...
		ConnectedKafkaCluster cluster = new ConnectedKafkaCluster("_test", mock(KafkaRepositoryContainer.class), adminClient,
				mock(KafkaConsumerFactory.class), futureDecoupler);
