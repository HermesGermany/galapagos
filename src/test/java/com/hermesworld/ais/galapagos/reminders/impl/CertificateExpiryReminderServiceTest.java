...
public class CertificateExpiryReminderServiceTest {
	...
	public void testMultipleEnvironmentsWithExpiredEach() {
		...
		CertificateExpiryReminder rem1 = reminders.get(0).getEnvironmentId().equals("test") ? reminders.get(0) : reminders.get(1);
		CertificateExpiryReminder rem2 = reminders.get(0).getEnvironmentId().equals("test") ? reminders.get(1) : reminders.get(0);
