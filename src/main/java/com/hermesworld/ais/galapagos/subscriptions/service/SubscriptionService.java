...
public interface SubscriptionService {
	 ...
	 * @param subscription  Metadata of an existing subscription (usually from a different environment). Its <code>id</code>
	 *                      property is <b>not</b> used when creating the new subscription. Other fields are copied.
