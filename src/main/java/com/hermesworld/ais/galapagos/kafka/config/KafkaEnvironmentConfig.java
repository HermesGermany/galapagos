...
public interface KafkaEnvironmentConfig {
     ...
     *         <code>null</code> to use the default. A value of 0 or lower indicates that developer certificates are
     *         disabled for this environment.
     */
    String getDeveloperCertificateValidity();

    /**
     * This DN must be configured in the Kafka Cluster to be allowed to perform all operations necessary for the
     * operation of Galapagos (usually, just ALL operations). This must be done manually once per Cluster. <br>
     * Galapagos will create a self-signed client certificate on the fly containing this DN for logging in to this
     * cluster.
     *
