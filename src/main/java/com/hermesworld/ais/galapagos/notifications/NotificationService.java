 ...
 * sent out by {@link com.hermesworld.ais.galapagos.notifications.impl.NotificationEventListener}, which uses this component.
 */
public interface NotificationService {

    /**
     * Notifies the (active) subscribers of the given topic. Allows to exclude a single user from notification, usually the one
     * performing the change leading to this notification.
     *
    ...
    CompletableFuture<Void> notifyRequestor(ApplicationOwnerRequest request,
    ...
    CompletableFuture<Void> notifyApplicationTopicOwners(String applicationId,
        NotificationParams notificationParams);
}
