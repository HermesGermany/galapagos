...
public class DeveloperCertificateController {
	...
	public DeveloperCertificateController(DeveloperCertificateService certificateService, CurrentUserService userService) {
	...
	public DeveloperCertificateDto createDeveloperCertificate(@PathVariable String environmentId) {
		String userName = userService.getCurrentUserName().orElseThrow(() -> new ResponseStatusException(HttpStatus.UNAUTHORIZED));
