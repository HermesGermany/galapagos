...
export class EnvironmentsService {
    ...
    public checkDeletion(environmentId: string, topic: Topic): Promise<Map<number, boolean>> {
        return firstValueFrom(
            this.http.get<Map<number, boolean>>('/api/schema/check-for-delete/' + environmentId + '/' + topic.name)
        );
    }
